              ...
              <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                ...
                <tbody>
                  ...
                  <tr class="text-center">
                        ...
                        <td>
                            <a href="{{route('category.restore', ['id' => $category->id])}}"><i class="fas fa-trash-restore"></i></a>
                            <a class="text-danger" href="{{route('category.hdelete', ['id' => $category->id])}}"><i class="fas fa-trash"></i></a>
                        </td>
                  </tr>
                  @endforeach
